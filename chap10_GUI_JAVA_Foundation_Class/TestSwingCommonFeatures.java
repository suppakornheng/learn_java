...
public class TestSwingCommonFeatures extends JFrame{
	public TestSwingCommonFeatures(){
		...
		jbtLeft.setBackground(Color.WHITE); //set button background
		jbtCenter.setForeground(Color.GREEN); //set button text color
		jbtRight.setToolTipText("This is the Right button.");// set text shows up when hover
